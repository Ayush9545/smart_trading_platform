            ...
            <div className="container border-top mt-5">
                <div className="row mt-5">
                    <div className="col text-muted">
                        ...
                        <img src="media/images/Screenshot1.png" style={{width: "100%"}}/>
                    </div>
                    <div className="col">
                        <p>Account</p>
